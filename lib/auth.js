...
function checkApiSecret(req, res) {
  // Nom canonique : AI_SMART_ROUTER_HEADER_KEY. API_SECRET conservé en repli
  // (compatibilité ascendante avec les anciens déploiements).
  const secret =
    process.env.AI_SMART_ROUTER_HEADER_KEY || process.env.API_SECRET;
